...
const dictionaries = {
  en: {
    ...
    endMeetingPromptTitle: 'Save meeting history?',
    endMeetingPromptBody: 'The meeting has ended. Would you like to keep the transcript from this session?',
    saveAsSummaryLabel: 'Save as a summary document',
    dontSave: "Don't save",
    chat: 'Chat',
  ...
  vi: {
    ...
    leave: 'Rời phòng',
    endMeeting: 'Kết thúc',
    endMeetingPromptTitle: 'Lưu lại lịch sử cuộc họp?',
    endMeetingPromptBody: 'Cuộc họp đã kết thúc. Bạn có muốn lưu lại transcript của phiên này không?',
    saveAsSummaryLabel: 'Lưu thành văn bản tóm tắt',
    dontSave: 'Không lưu',
    chat: 'Trò chuyện',
