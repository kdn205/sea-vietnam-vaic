...
const dictionaries = {
  en: {
    ...
    micRequestDeclined: 'Your request to speak was declined.',
    approve: 'Approve',
    decline: 'Decline',
    ...
    copy: 'Copy',
    explain: 'Explain',
    notConfiguredMessage: 'Gemini is not set up correctly yet.',
    inProgress: 'In progress',
    untitledSession: 'Session',
    noSessionsYet: 'No sessions yet.',
    noSummarySessionsYet: 'No summarized sessions yet.',
    summary: 'Summary (Gemini)',
    endSessionTitleSelf: 'Save this conversation?',
    endSessionTitleDisconnected: 'Session ended',
    endSessionBodySelf: 'Do you want to save this conversation history before leaving?',
    endSessionBodyDisconnected:
      'The presenter has ended the meeting (or the connection was lost). Do you want to save this conversation history before leaving?',
    saveAsSummaryOption: 'Save as a summary (Gemini)',
    saveAsSummaryDisabledHint: 'Tap to set up Gemini and enable summaries.',
    discardHistory: "Don't save",
  ...
  vi: {
    ...
    micRequestDeclined: 'Yêu cầu phát biểu của bạn đã bị từ chối.',
    approve: 'Duyệt',
    decline: 'Từ chối',
    ...
    copy: 'Sao chép',
    explain: 'Giải thích',
    notConfiguredMessage: 'Gemini chưa được thiết lập đúng cách.',
    inProgress: 'Đang diễn ra',
    untitledSession: 'Phiên',
    noSessionsYet: 'Chưa có phiên nào.',
    noSummarySessionsYet: 'Chưa có phiên tóm tắt nào.',
    summary: 'Tóm tắt (Gemini)',
    endSessionTitleSelf: 'Lưu lại cuộc hội thoại này?',
    endSessionTitleDisconnected: 'Phiên đã kết thúc',
    endSessionBodySelf: 'Bạn có muốn lưu lại lịch sử hội thoại này trước khi rời đi không?',
    endSessionBodyDisconnected:
      'Người trình bày đã kết thúc cuộc họp (hoặc mất kết nối). Bạn có muốn lưu lại lịch sử hội thoại trước khi rời đi không?',
    saveAsSummaryOption: 'Lưu thành bản tóm tắt (Gemini)',
    saveAsSummaryDisabledHint: 'Chạm để thiết lập Gemini và bật tính năng tóm tắt.',
    discardHistory: 'Không lưu',
